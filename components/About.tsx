    ...
    <section className='h-screen w-full bg-about bg-cover bg-right lg:bg-center section flex flex-row items-center justify-center'>
      ...
      <div className='flex flex-col justify-center items-center w-full lg:px-0 lg:py-0 px-5 lg:ml-60 xl:ml-80 2xl:ml-108 iPadWidescreen:ml-60 iPadProWidescreen:ml-80 iPadPro:ml-56 py-auto'>
        <div className='flex flex-col justify-center items-center pb-10 lg:pb-16 iPadWidescreen:max-w-md'>
          ...
          <p className='max-w-lg mt-5 lg:mt-10 text-xs iPadWidescreen:text-sm lg:text-base iPadAir:text-base font-bodyMain text-gray-900 text-center'>
            I have an LLB(Hons) in Law and a Micromasters in Cybersecurity.
          </p>
          <p className='max-w-lg mt-5 text-xs iPadWidescreen:text-sm  lg:text-base font-bodyMain iPadAir:text-base text-gray-900 text-center'>
        ...
        <div className='flex flex-col justify-center items-center max-w-lg'>
          ...
          <ul className='pt-5 text-xs iPadWidescreen:text-sm lg:text-base iPadAir:text-base'>
