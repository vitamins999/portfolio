    ...
    <section className='relative h-screen w-full bg-ubooze bg-center bg-cover bg-no-repeat flex flex-col justify-center items-center section'>
      ...
      <div className='absolute top-0 left-0 h-screen w-full flex flex-col justify-center items-center'>
        <div className='z-10 flex flex-col justify-center items-center px-5 md:px-0'>
          <h1 className='font-headingUbooze text-8xl samsungS7:text-6xl lg:text-8xl iPad:text-8xl iPadWidescreen:text-8xl iPadPro:text-8xl iPadProWidescreen:text-8xl text-green-600'>
            Ubooze
          </h1>
          <h2 className='font-bodyUbooze samsungS7:text-xs text-gray-200 tracking-widest md:-mt-0 -mt-2'>
            A fullstack Next.js web app
          </h2>
          <p className='md:max-w-lg mt-10 samsungS7:mt-4 text-sm md:text-base font-bodyUbooze text-gray-100 text-center'>
          ...
          <p className='md:max-w-lg max-w-md mt-5 samsungS7:mt-2 text-sm md:text-base font-bodyUbooze text-gray-100 text-center'>
          ...
          <div className='lg:py-5 mt-10 samsungS7:mt-4 flex md:flex-row flex-col items-center'>
            <a
