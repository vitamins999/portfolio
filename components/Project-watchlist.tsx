...
const ProjectWatchlist = () => {
  return (
    <section className='h-screen w-full bg-watchlistPortrait lg:bg-watchlist iPadPro:bg-watchlistPortrait iPadProWidescreen:bg-watchlistPortrait iPad:bg-watchlistPortrait iPadWidescreen:bg-watchlistPortrait bg-center bg-cover bg-no-repeat section flex'>
      <div className='flex flex-col justify-center lg:items-end iPadProWidescreen:items-center iPadPro:items-center iPadWidescreen:items-center iPad:items-center xl:mr-16 lg:mr-5 2xl:mr-64 xs:-mt-0 -mt-28 iPadProWidescreen:mr-0 iPad:-mt-20 iPadPro:-mt-32'>
        <div className='flex flex-col justify-center items-center'>
          <h1 className='font-headingWatchlist text-5xl lg:text-7xl iPad:text-7xl text-red-700'>
            Watchlist
          </h1>
          <h2 className='font-bodyWatchlist text-sm lg:text-base text-gray-800 tracking-wider'>
            A serverless Next.js web app
          </h2>
          <p className='xl:max-w-lg lg:max-w-md max-w-lg mt-10 text-sm lg:px-0 px-5 lg:text-base font-bodyWatchlist text-gray-900 text-center'>
          ...
          <p className='xl:max-w-lg lg:max-w-md max-w-lg mt-5 text-sm lg:px-0 px-5 lg:text-base font-bodyWatchlist text-gray-900 text-center'>
            Technologies used include Next.js, Serverless Functions, Context
            API, Axios and Cheerio.
          </p>
          <div className='flex lg:flex-row flex-col lg:py-5 mt-10 iPad:items-center items-center'>
            <a
